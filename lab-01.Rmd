...
Because there are some values in the table that are labelled as"NA" therefore a mean and a median cannot be calculated since character>double.
...
There are some very large numbers that push the mean away from the median.
